...
banner = f"""
        ...
        {xanh_duong}██║░░██║██║███████╗╚██████╔╝  ░░░██║░░░╚█████╔╝╚█████╔╝███████╗
        {trang}╚═╝░░╚═╝╚═╝╚══════╝░╚═════╝░  ░░░╚═╝░░░░╚════╝░░╚════╝░╚══════╝
{trang}           </> Đăng kí kênh yotube hiếu tool </>
\033[1;37m────────────────────────────────────────────────────────────
{do}[{trang}{kt_code}{do}] {vang}BOT VIEW TIK TOK MAX SPEED 
{do}[{trang}{kt_code}{do}] \033[1;35mADMIN:\033[1;36m HIẾU-TOOL
{do}[{trang}{kt_code}{do}] \033[1;31mZALO: \033[1;33m 84939271874
{do}[{trang}{kt_code}{do}] {dac_biet}YOUTUBE:\033[1;37m HIẾU-TOOL
\033[1;37m────────────────────────────────────────────────────────────"""
        ...
        try:
            ...
            try:
                if response.json()['status_code'] == 0:
                    _lock.acquire()
                    print(f'{do}[{vang}VuaSubNgon{do}] {do}[{xanh_la}BUFF VIEW SUCCESS{do}] {do}{xanh_duong}+: {trang}{success}{do} View')
                    success += 1
                    _lock.release()
            except:
